...
I'm **Mohammad Parvez**, widely known as **Jony** — a professional **Graphic Designer**, **Web Designer**, and **MERN Stack Web Developer** with deep experience in both creative design and modern full-stack web development.

I am the **Founder & CEO** of two companies:

| Company | Website | Description |
|---------|---------|-------------|
| 🏢 **Shopnil IT** | [shopnilit.com](https://shopnilit.com) | Full-service digital solutions — enterprise-grade web design, scalable web development, and high-quality product image retouching |
| 📸 **FIXED THE PHOTO** | [fixedthephoto.com](https://fixedthephoto.com) | Premium e-commerce product image editing and retouching solutions for brands and online sellers |

- 🔭 Currently building **scalable full-stack applications** and delivering **commercial-grade image retouching** for global clients
- 🌍 Collaborating with **international clients** and managing **end-to-end project workflows** from concept to deployment
- 💼 Operating an established **Fiverr freelance business** with **250+ global client reviews**
- 🎯 I value **clear communication**, **structured problem-solving**, and **production-ready solutions**
- ⚡ My approach emphasizes **clean code**, **scalability**, **performance optimization**, **security**, and **responsive UI/UX**

---

## 🎨 Graphic Design & Image Retouching Expertise

As a specialist in **high-end product image editing** for e-commerce, I deliver commercially optimized visuals that enhance product presentation, brand credibility, and conversion performance.

| Service | Description |
|---------|-------------|
| ✂️ **Clipping Path** | Precision hand-drawn paths for clean product isolation |
| 🖼️ **Background Removal** | Seamless background removal and replacement |
| 🎨 **Advanced Color Correction** | Professional color grading and consistency |
| 🌑 **Shadow Creation** | Natural, reflection, and drop shadow effects |
| 💎 **Jewelry Retouching** | High-end jewelry photo editing and enhancement |
| 👕 **Apparel Retouching** | Clothing photo editing, wrinkle removal, and color adjustment |
| 👻 **Ghost Mannequin** | Invisible mannequin / neck joint services |
| ✨ **Premium Product Enhancement** | Complete product photo optimization for e-commerce |

> 🎯 *Supporting product photographers, brands, and online sellers by delivering consistent, commercially optimized visuals.*
...
const mohammadParvez = {
    ...
    principles: [
        ...
        "Clear communication & structured problem-solving"
    ],
    currentFocus: "Building scalable full-stack applications & delivering world-class image retouching",
    funFact: "I turn complex ideas into elegant code and raw images into stunning visuals ✨"
};
```
